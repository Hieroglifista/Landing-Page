...
import TextoProps from "@/components/textoprops";
export default function Home() {
  return (
    <main className="flex ">
      <div className="w-500 h-50">
        <Grave></Grave>
      </div>

      <div className="flex flex-col w-500 h-50">
        <Ice></Ice>
